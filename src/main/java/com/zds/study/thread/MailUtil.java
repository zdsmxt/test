...
public class MailUtil {
    ...
    public static Properties SMTP_KUNGEEK(Boolean debug) {
        Properties props = defaultConfig(debug);
        props.put("mail.smtp.host", "smtp.kungeek.com");
        return props;
    }
     ...
     */
    public static MailUtil subject(String subject) throws SendMailException, MessagingException {
        MailUtil mailUtil = new MailUtil();
        mailUtil.msg = new MimeMessage(session);
        try {
            mailUtil.msg.setSubject(subject, "UTF-8");
        } catch (Exception e) {
     ...
     */
    public MailUtil from(String nickName) throws SendMailException {
     ...
     */
    public MailUtil from(String nickName, String from) throws SendMailException {
        try {
    ...
    public MailUtil replyTo(String... replyTo) throws SendMailException {
    ...
    public MailUtil to(String... to) throws SendMailException {
        try {
    ...
    public MailUtil cc(String... cc) throws SendMailException {
        try {
    ...
    public MailUtil bcc(String... bcc) throws SendMailException {
        try {
    ...
    public MailUtil attach(File file) throws SendMailException {
        attachments.add(createAttachment(file, null));
        return this;
    }

    public MailUtil attach(File file, String fileName) throws SendMailException {
        attachments.add(createAttachment(file, fileName));
        return this;
    }

    public MailUtil attachURL(URL url, String fileName) throws SendMailException {
